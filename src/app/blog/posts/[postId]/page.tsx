...
export default async function Post({ params }: { params: {postId: string }}) {
    ...
    const { title, date, category, author, contentHtml } = await getPostData(postId)

    const pubDate = getFormattedDate(date)
  
    return (
    <div className='mx-auto w-6/12 my-20'>
        <h1 className='text-7xl mt-8 mb-6 w-9/12 mx-auto'>{title}</h1>
        ...
        <Image className="mb-12 w-full" src='/steuer.jpg' width={5568} height={3712} alt="image"/>
